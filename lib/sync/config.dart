...
/// Where an invitation link sends people.
///
/// Its own constant rather than derived from [kApiBaseUrl]: the page that
/// explains an invitation is on the marketing site, which is a different
/// origin and a different deploy. A build pointed at a local API still wants
/// real links unless it is told otherwise.
