    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Sign in first, then one purchase unlocks Pro everywhere you use '
            'Kapy Notes.',
            style: TextStyle(
  ...
  Widget _finePrint(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text(
          billing.isSignedIn
              ? 'Payment is handled by Apple. Pro stays with this Kapy Notes '
                    'account.'
              : 'Pro is linked to the Kapy Notes account that buys it.',
          textAlign: TextAlign.center,
